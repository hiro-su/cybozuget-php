...
class nusoap_base {
    ...
    */
	...
	'<SOAP-ENV:Envelope'. $this->grn_env . ">".
	$headers.
	"<SOAP-ENV:Body>".
		$body.
	"</SOAP-ENV:Body>".
...
/**
*
* [nu]soapclientx higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $soapclientx = new nusoap_client( string path [ ,mixed wsdl] );
*
* // call method, get results
* echo $soapclientx->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($soapclientx);
*
...
class nusoap_client extends nusoap_base  {
	...
	/*
	 * Cybozu Groon Envelope Set Function
	 */
	function setGrnEnv($value){
		return $this->grn_env = $value;
	}
...
if (!extension_loaded('soap')) {
	/**
	 *	For backwards compatiblity, define soapclientx unless the PHP SOAP extension is loaded.
	 */
	class soapclientx extends nusoap_client {
	}
}
?>
